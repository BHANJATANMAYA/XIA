...
PROFILES: Dict[str, dict] = {
    ...
    "fast": {
        ...
        "preferred":   ["qwen3.5", "qwen3.5:4b", "phi4", "phi3", "phi3:mini",
                        "gemma2:2b", "qwen2.5:3b", "llama3.2:3b"],
        "fallback":    "mistral",
        "temperature": 0.7,
    },
    "smart": {
...
FAST_SIGNALS = [
    ...
    "what does", "meaning of", "translate", "suggest", "recommend",
    "give me a", "list some", "name a few",
]
